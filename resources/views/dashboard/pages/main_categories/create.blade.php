                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 mt-2">
                                    <div class="form-group form-float">
                                        <label class="d-block font-weight-bold" for="name">Name ({{ $lang->name }})</label>
                                        <input type="text" class="form-control valid"
                                            placeholder="Electronics, Cloths, Food..." name="category[{{$key}}][name]"
                                            aria-required="true">
                                ...
                                <div class="col-lg-12 col-md-12 mb-3">
                                    ...
                                    <label class="toggle-switch">
                                        <input value="1" type="checkbox" name="category[{{$key}}][active]">
