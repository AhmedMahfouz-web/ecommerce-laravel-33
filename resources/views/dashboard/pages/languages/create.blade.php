...
<li class="breadcrumb-item"><a href="{{route('admin.languages')}}"><i class="fa fa-language" aria-hidden="true"></i>
        Languages</a></li>
<li class="breadcrumb-item active"><i class="fa fa-plus" aria-hidden="true"></i> Add Language</li>
@endsection
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <form id="wizard_with_validation" action="{{ route('admin.languages.store') }}" method="POST">
                    @csrf
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group form-float">
                                        ...
                                        <input type="text" class="form-control valid" placeholder="Abbr" name="abbr"
                                            id="abbr" required="" aria-required="true">
                                        @error("abbr")
                                        <span class="text-danger">هذا الحقل مطلوب</span>
                                        @enderror
                                    </div>
