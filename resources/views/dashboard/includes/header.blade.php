                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="index.html">
                        <img class="brand-logo" alt="modern admin logo"
                            src={{ asset("/../../dashboard/images/logo/33-logo.png") }}>
<h3 class="brand-text">ThirtyThree House</h3>
</a>
</li>
                        ...
                        <div id="mega-menu-carousel-example">
                            <div>
                                <img class="rounded img-fluid mb-1"
                                    src={{ asset("/../../dashboard/images/slider/slider-2.png") }} alt="First slide"><a
                                    class="news-title mb-0" href="#">Poster Frame
                                    PSD</a>
                    ...
                    <li class="col-md-3">
                        ...
                        <ul class="drilldown-menu">
                            <li class="menu-list">
                                <ul>
                                    <li>
                                        <a class="dropdown-item" href="layout-2-columns.html"><i class="ft-file"></i>
                                            Page layouts & Templates</a>
                                    </li>
                                    <li><a href="#"><i class="ft-align-left"></i> Multi level menu</a>
                                        <ul>
                                            <li><a class="dropdown-item" href="#"><i class="la la-bookmark-o"></i>
                                                    Second level</a></li>
                                            <li><a href="#"><i class="la la-lemon-o"></i> Second level
                                                    menu</a>
                                                <ul>
                                                    <li><a class="dropdown-item" href="#"><i class="la la-heart-o"></i>
                                                            Third level</a>
                                                    </li>
                                                    <li><a class="dropdown-item" href="#"><i class="la la-file-o"></i>
                                                            Third level</a>
                                                    </li>
                                                    <li><a class="dropdown-item" href="#"><i class="la la-trash-o"></i>
                                                            Third level</a>
                                                    </li>
                                                    <li><a class="dropdown-item" href="#"><i class="la la-clock-o"></i>
                                                            Third level</a>
                                                    </li>
                                                </ul>
                                            </li>
                                    ...
                                    <li><a class="dropdown-item" href="sk-2-columns.html"><i class="ft-edit"></i> Page
                                            starter kit</a></li>
                                    <li><a class="dropdown-item" href="changelog.html"><i class="ft-minimize-2"></i>
                                            Change log</a></li>
                                    <li>
                        ...
                        <div id="accordionWrap" role="tablist" aria-multiselectable="true">
                            <div class="card border-0 box-shadow-0 collapse-icon accordion-icon-rotate">
                                ...
                                <div class="card-header p-0 pb-2 border-0" id="headingTwo" role="tab"><a
                                        ...
                                        aria-controls="accordionTwo">Accordion Item
                                        #2</a></div>
                                ...
                                <div class="card-header p-0 pb-2 border-0" id="headingThree" role="tab"><a
                                        ...
                                        aria-controls="accordionThree">Accordion Item
                                        #3</a></div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="position-relative has-icon-left">
                                            ...
                                            <div class="form-control-position pl-1"><i class="la la-envelope-o"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="position-relative has-icon-left">
                                            ...
                                            <div class="form-control-position pl-1"><i class="la la-commenting-o"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <li class="dropdown dropdown-user nav-item">
                <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                    ...
                    <span class="avatar avatar-online">
                        <img src={{ asset("/../../dashboard/images/portrait/small/avatar-s-19.png") }}
                            alt="avatar"><i></i></span>
                </a>
                    ...
                    <li class="scrollable-container media-list w-100">
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <span class="avatar avatar-sm avatar-busy rounded-circle">
                                        <img src={{ asset("/../../dashboard/images/portrait/small/avatar-s-2.png") }}
                                            alt="avatar"><i></i></span>
                                </div>
                                <div class="media-body">
                        ...
                        <a href="javascript:void(0)">
                            <div class="media">
                                <div class="media-left">
                                    <span class="avatar avatar-sm avatar-online rounded-circle">
                                        <img src={{ asset("/../../dashboard/images/portrait/small/avatar-s-3.png") }}
                                            alt="avatar"><i></i></span>
                                </div>
                                <div class="media-body">
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <span class="avatar avatar-sm avatar-away rounded-circle">
                                        <img src={{ asset("/../../dashboard/images/portrait/small/avatar-s-6.png") }}
                                            alt="avatar"><i></i></span>
                                </div>
                                <div class="media-body">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link nav-link-icon" href="javascript:void(0);" id="navbar_1_dropdown_3" role="button"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-list"></i></a>
